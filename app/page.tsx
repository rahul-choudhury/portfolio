          ...
          <div className="grid grid-cols-1 md:grid-cols-12">
            ...
            <div className="md:col-span-8">
              {PROJECTS.map((project) => (
                <div
                  key={project.title}
                  className="group relative border-b-2 border-black p-6 transition-colors duration-300 last:border-b-0 hover:bg-black hover:text-[var(--color-hover-text)] md:p-12"
                >
                  <Link
                    href={project.link}
                    target="_blank"
